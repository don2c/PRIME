...
def load_ehealth() -> DomainData:
    events = pd.read_csv("/mnt/data/prime_ring_ehealth_access_log.csv")
    edges = pd.read_csv("/mnt/data/prime_ring_ehealth_staff_graph_edges.csv")
...
def load_osn(name: str) -> DomainData:
    ...
    users = pd.read_csv(f"/mnt/data/prime_ring_osn_{base}_users.csv")
    edges = pd.read_csv(f"/mnt/data/prime_ring_osn_{base}_edges.csv")
    actions = pd.read_csv(f"/mnt/data/prime_ring_osn_{base}_actions.csv")
